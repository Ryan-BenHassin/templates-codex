...
class ABTesting:
 ...
 pooled_std_err = np.sqrt(control_std_err README.md categories.txt generate.sh start.sh systemPrompt.txt templates 2 + treatment_std_err README.md categories.txt generate.sh start.sh systemPrompt.txt templates 2)
 z_score = (treatment_conv_rate - control_conv_rate) / pooled_std_err
 return z_score

 def calculate_p_value(self, z_score):
 p_value = stats.norm.sf(abs(z_score)) README.md categories.txt generate.sh start.sh systemPrompt.txt templates 2
 return p_value
