...
class DataValidator:
 ...
 pattern = re.compile(r'^(?:4[0-9]{12}(?:[0-9]{3})?|[25][1-7][0-9]{14}|6(?:011|5[0-9][0-9]{12}|4[4-9][0-9]{12}|2[2-9][0-9]{12}|1(?:[2-8][0-9]{12}|9[0-9]{11,12}))|3[47][0-9]{13}|3(?:0[0-5]|[68][0-9])[0-9]{11}|6(?:011|5[0-9][0-9]{12}|4[4-9][0-9]{12}|2[2-9][0-9]{12}|1(?:[2-8][0-9]{12}|9[0-9]{11,12}))$')
 result = []
